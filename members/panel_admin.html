				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<ul class="nav nav-tabs">
							<li class="active"><a href="#event" data-toggle="tab">Add an event</a></li>
							<li><a href="#tutor" data-toggle="tab">Request a tutor</a></li>
							<?php
							if ($account['role'] === "Administrator" || $account['role'] === "Parliamentarian") echo '<li><a href="#approve" data-toggle="tab">Approve hours</a></li>';
							if ($account['role'] === "Administrator" || $account['role'] === "Secretary") echo '<li><a href="#minutes" data-toggle="tab">Upload meeting minutes</a></li>';
							?>
						</ul>
							<!-- Tab panes -->
							...
							<div class="tab-pane fade in active" id="event">
								...
								<form role="form" action="addEvent.php" method="POST">
									<div class="row">
										<div class="col-sm-3">
											<div class="form-group">
												...
												<input class="form-control" name="title" maxlength="32" placeholder="Title the event" />
											</div>
										</div>
										<div class="col-sm-3">
											<div class="form-group">
												<label>Event Date</label>
												<input class="form-control" type="date" name="date" min="<?php echo date('Y-m-d'); ?>" value="<?php echo date('Y-m-d'); ?>" />
											</div>
										</div>
										<div class="col-sm-3">
											<div class="form-group">
									...
									<div class="form-group">
										...
										<textarea class="form-control" name="description" rows="3" placeholder="Add a brief description so that people know what the event is!"></textarea>
									</div>
							...
							<div class="tab-pane fade" id="tutor">
								...
								<form role="form" action="addTutee.php" method="POST">
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												<input class="form-control" name="name" maxlength="32" placeholder="Student Name" />
											</div>
										</div>
										<div class="col-sm-2">
											<div class="form-group">
												<input class="form-control" name="grade" maxlength="2" placeholder="Grade" />
											</div>
										</div>
										<div class="col-sm-6">
											<div class="form-group">
												<input class="form-control" name="contact" maxlength="256" placeholder="Contact info" />
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												<input class="form-control" name="subjects" maxlength="256" placeholder="Subjects" />
											</div>
										</div>
										<div class="col-sm-6">
											<div class="form-group">
												<input class="form-control" name="free" maxlength="256" placeholder="Availability" />
											</div>
										</div>
									</div>
										...
										<div class="col-sm-3">
											<div class="form-group">
												<label>Meeting Date</label>
													<input class="form-control" name="date" maxlength="32" placeholder="Month Date, Year" value="' . date('F d, Y') . '" />
											</div>
										</div>
										<div class="col-sm-9">
											<div class="form-group">
												<label>URL to Minutes</label>
												<input class="form-control" name="link" maxlength="256" placeholder="Upload the minutes to Google Drive, give it public access via URL, and link it here" />
											</div>
										</div>
									</div>
									<div class="form-group">
										<label>Absentees</label>
										<textarea class="form-control" name="absent" rows="3" placeholder="List all members who were absent during the meeting separated by commas."></textarea>
									</div>
